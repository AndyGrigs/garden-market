...
export default function CheckoutModal({
  ...
  const [paymentMethod, setPaymentMethod] = useState<
    'paypal' | 'runpay' | 'paynet' | 'card' | null
  >(null);
    ...
    if (!user) {
      toast.error(
        t('checkout.loginRequired', {
          defaultValue: 'Необходимо войти в систему',
        })
      );
      return null;
    }
    ...
    try {
      ...
      toast.success(
        t('checkout.orderCreated', {
          defaultValue: 'Заказ создан, выберите способ оплаты',
        })
      );
      return order._id;
    } catch (error) {
      ...
      toast.error(
        t('checkout.orderError', { defaultValue: 'Ошибка создания заказа' })
      );
      return null;
    }
  };
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input
                type="text"
                placeholder={
                  t('checkout.name', { defaultValue: 'Полное имя' }) + ' *'
                }
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <h3 className="font-semibold mb-2">
              {t('checkout.orderSummary', { defaultValue: 'Итоги заказа' })}
            </h3>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4">
              {t('checkout.paymentMethod', { defaultValue: 'Способ оплаты' })}
            </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
              ...
              >
                ...
                <span className="font-semibold">
                  {t('checkout.card', { defaultValue: 'Карта' })}
                </span>
            ...
            <div className="space-y-3">
              ...
              {paymentMethod === 'runpay' && orderId && (
                <div className="border-t pt-4">
                  <RunPayButton orderId={orderId} amount={total} />
                </div>
              )}
