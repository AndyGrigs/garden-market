...
const TermsAndConditions = () => {
  ...
  content: [
    "Настоящие Условия регулируют использование онлайн-платформы для продажи саженцев деревьев (далее «Платформа»).",
    "Платформа выступает в качестве посредника между продавцами и покупателями.",
    "Администрация платформы не является продавцом товаров и не несет ответственности за качество товаров.",
...
},  
{
  ...
  content: [
    ...
    "Продавец несет полную ответственность за качество, описание и доставку своих товаров.",
    ...
    "Продавец самостоятельно устанавливает цены и условия продажи своих товаров.",
    "Споры между продавцом и покупателем решаются напрямую между сторонами."
  ]
},
    {
      id: "products",
